...
kafka-consumer-groups.sh --command-config playground.config --bootstrap-server adapted-skunk-13673-eu2-kafka.upstash.io:9092 --group my-first-application --reset-offsets --to-earliest --topic third_topic --dry-run

# execute flag is needed
kafka-consumer-groups.sh --command-config playground.config --bootstrap-server adapted-skunk-13673-eu2-kafka.upstash.io:9092 --group my-first-application --reset-offsets --to-earliest --topic third_topic --execute
